...
export default function OwnershipHomeScreen() {
  ...
  const yachtModels = [
    ...
    { id: "D42", name: "D42", length: "42ft", passengers: 12, price: "€650K", sharesFrom: "€130K", image: "https://static.wixstatic.com/media/0fb4c8_008f1545c8764f8789a2b7415ca9dde7~mv2.jpg/v1/crop/x_0,y_129,w_1920,h_823/fill/w_800,h_400,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/THE%20RANGE_PORTADA_D42.jpg" },
    { id: "D50", name: "D50", length: "50ft", passengers: 12, price: "€950K", sharesFrom: "€190K", image: "https://static.wixstatic.com/media/0fb4c8_60988eb5cf834fcb876c1d06bd8af594~mv2.jpg/v1/crop/x_0,y_129,w_1920,h_823/fill/w_800,h_400,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/THE%20RANGE_PORTADA_D50.jpg" },
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="relative">
        {/* Extended Sea Background - covers header + extends under hero card */}
        <div className="absolute inset-0 bg-gradient-ocean" style={{ height: '320px' }}>
