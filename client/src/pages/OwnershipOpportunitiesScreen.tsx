  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 bg-gradient-ocean" style={{ height: '295px' }}>
        ...
        {/* Hero Section */}
        <section className="relative px-4 overflow-hidden" style={{ paddingTop: '0px', paddingBottom: '8px' }}>
